package com.x_ken.btserialcomx_ken;
...
public class MainActivity extends Activity {
    ...
    private final String DEVICE_ADDRESS="98:D3:32:70:68:A1";
    private final UUID PORT_UUID = UUID.fromString("00001101-0000-1000-8000-00805f9b34fb");//Serial Port Service ID
    private BluetoothDevice device;
    private BluetoothSocket socket;
    private OutputStream outputStream;
    private InputStream inputStream;
    Button startButton, sendButton,clearButton,stopButton,blueled,redled,greenled,offled;
    TextView textView;
    EditText editText;
    ...
    public void onClickSend(View view) {
        ...
        textView.setText("Sent Data: " + string);
